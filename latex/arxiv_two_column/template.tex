...
\PassOptionsToPackage{natbib}{numbers,square}
\PassOptionsToPackage{fontenc}{T1} % use 8-bit T1 fonts
% colors for hyperlinks
\PassOptionsToPackage{hyperref}{colorlinks = true,
linkcolor = purple,
urlcolor  = blue,
citecolor = cyan,
anchorcolor = black}
...
[# if author.orcid #]\newcommand{\[[author.name.replace(" ","")]]}{author.orcid}[# endif #]
[# endfor #]
